...
import org.pac4j.play_25.CallbackController;
...
public class RequiresAuthenticationAction extends AbstractConfigAction {
    ...
    protected CompletionStage<Result> forbidden(final org.pac4j.play_25.PlayWebContext context, final List<Client> currentClients, final UserProfile profile) {
        return CompletableFuture.completedFuture((Result) config.getHttpActionAdapter().adapt(HttpConstants.FORBIDDEN, context));
    }

    protected boolean startAuthentication(final org.pac4j.play_25.PlayWebContext context, final List<Client> currentClients) {
        return currentClients != null && !currentClients.isEmpty() && currentClients.get(0) instanceof IndirectClient;
    }
    ...
    protected Result redirectToIdentityProvider(final org.pac4j.play_25.PlayWebContext context, final List<Client> currentClients) {
        try {
    ...
    protected CompletionStage<Result> unauthorized(final org.pac4j.play_25.PlayWebContext context, final List<Client> currentClients) {
